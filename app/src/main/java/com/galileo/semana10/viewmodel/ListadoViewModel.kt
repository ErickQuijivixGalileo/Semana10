package com.galileo.semana10.viewmodel
...
import com.galileo.semana10.network.RetrofitClient
    ...
    fun getPersonajes() {
        ...
        viewModelScope.launch(Dispatchers.IO) {
            try {
                ...
                _personajes.postValue(ArrayList(response.items))
                Log.d("Message", "tamano ${response.items.size}")
            } catch (e: Exception) {
